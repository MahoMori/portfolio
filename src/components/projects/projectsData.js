...
const projectsData = [
  ...
  },
  {
    ...
    description:
      "The website that users can add, edit and delete lists of places to go and things to do. It has complete CRUD feature. It will be implemented with Firebase for signing up and logging in feature so that the list can be for a group of specific people. When users log in, they will have their own panels for an individual list for each person.",
    // description:
